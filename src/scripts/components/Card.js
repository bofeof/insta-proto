export class Card {
  constructor(data, templateSelector, handleCardClick,  handleCardRemove, handleCardLike, userId) {
    ...
    this._galleryItemLikeCounter =  this._galleryItem.querySelector('.gallery__like-counter');
